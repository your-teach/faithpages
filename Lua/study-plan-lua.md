...
## Циклы.
    ...
    -for
        ...
        -Очень важно: если перебирать таблицу-словарь через цикл for, то порядок элементов будет рандомный
...
--Существует два вида функций: невозвращаемые и возвращаемые функции.

-- Простой пример создания функции:

function robot() -- объявление функции
    print("Приветствие робота:")
...
function robot2(name, age)
    print("Приветствие робота:")
    print("Здравствуйте, " .. name)
    print("Я знаю что вам " .. age .. " лет")
end
...
-- Возвращаемая функция (return)
function summa(a, b)
    result = a + b
    return result -- возвращаем результат в место запуска функции
end

r = summa(5, 10) -- место запуска функции
print(r)
