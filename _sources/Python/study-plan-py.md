...
raise BaseException("Свое описание ошибки") from err
# err.args = ("Мое описание ошибки",) # При этом err.__cause__ будет всегда возвращать дефолтное описание ошибки
# raise # Поднимает изначальную ошибку, удобно использовать если надо в except снова вызвать исходную ошибку
```
